	...
	[5] = {
		specs = {
			[256] = {
				...
				[8] = {
					label = "Ansurek",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAAA2mtZGD2GjZmxMbmtZmZmhBAAAAAAAAAAAzilZbYbmZMmFGzwMGsswMNELDYmBACwsNLLgxmN",
				},
			},
			[257] = {
				[0] = {
	...
	[7] = {
		specs = {
			...
			[264] = {
				...
				[8] = {
					label = "Ansurek",
					talentString = "CgQAAAAAAAAAAAAAAAAAAAAAAAAAAAAGAAAAAjZmZWmx2YmxMbz2MLGWwCsAzYTjlBwMwGzwCjtZmZmMLLMz0YGMbYZmZGMGmlxAAYYA",
				},
			},
		},
	},
	[8] = {
		specs = {
			...
			[62] = {
				...
				[7] = {
					label = "The Silken Court",
					talentString = "C4DAAAAAAAAAAAAAAAAAAAAAAAmZbWmxMmZmFYMzwYamxAAAAAAgBAAAmZ2WWWmZiFAAAAAAAwyMGmZmZGzwMzMGzYmZGDjB",
				},
				[8] = {
					label = "Ansurek",
	...
	[10] = {
		specs = {
			[268] = {
				...
				[6] = {
					label = "Kyveza",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAAGjxMMsMjtZmZGDAAAAAAwyCGxMDMDjNzgtZmZY2GzM2sYab5B2mtZmhZBAA2AAAAmtZpZmZWYGsA",
				},
				[7] = {
					label = "The Silken Court",
	...
	[11] = {
		specs = {
			...
			[103] = {
				...
				[5] = {
					label = "Broodtwister Ovinax",
					talentString = "CcGAAAAAAAAAAAAAAAAAAAAAAAAAAAAAmZb2MzCzMzML2GsNzMz8AzMAAAAAALBYMYMzMamxMMzYMjZbMAAAAAAAAAAAA0MLzyMz2AAWgZGAA",
				},
				[6] = {
					label = "Kyveza",
					talentString = "CcGAAAAAAAAAAAAAAAAAAAAAAAAAAAAgxMbMmFzMmZ2mtHwYbmZGPwMDAAAAAwWwYGwYmZ0MjZYmZYG2GDAAAAAAAAAAAANzysMzsNAgFYmBA",
				},
				[7] = {
					label = "The Silken Court",
	...
	[12] = {
		specs = {
			...
			[581] = {
				...
				[5] = {
					label = "Broodtwister Ovinax",
					talentString = "CUkAAAAAAAAAAAAAAAAAAAAAAAAYMzMjhZkZmxMDzMbjBjtZMjZMDzMjZmZbmZYGMAAAAALziZMMbMNwMzMsB",
				},
				[6] = {
					label = "Kyveza",
					talentString = "CUkAAAAAAAAAAAAAAAAAAAAAAAAGjZmZMmZkZmxYYMbzMYsNjZegZMzwMjZGbjZYGMAAAAALziZMMbMNwMzMsB",
