	...
	[5] = {
		specs = {
			[256] = {
				...
				[4] = {
					label = "Forgeweaver Araz",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAAgNmZYGjxMDzsx2MzMzMzMAAAAAAAAAAYWmlZbwMzgZhxMMjBLbMTjJWmBYmFsQYMbDwYDLAAA",
				},
				[5] = {
					label = "The Soul Hunters",
				...
				[7] = {
					label = "Nexus King Salhadaar",
					talentString = "CAQAAAAAAAAAAAAAAAAAAAAAAAgNmZMzYMmZGzsNz2MzMzMAAAAAAAAAAAzysMbDmZGMLMmBjBLbPgZaMxyAzMAQAmtZbDM2sBAA",
				},
				[8] = {
					label = "Dimensius",
	...
	[9] = {
		specs = {
			[265] = {
				...
				[7] = {
					label = "Nexus King Salhadaar",
					talentString = "CkQAAAAAAAAAAAAAAAAAAAAAAMMzMmZmhY2MwsNzMDz2AAAAmZMziZmxyMzMLGmZAAzYBGYWMaMDgZDsMDAAAAAAAAmxsB",
				},
				[8] = {
					label = "Dimensius",
					talentString = "CkQAAAAAAAAAAAAAAAAAAAAAAAzMzMzMjY2MwsNzMDz2AAAAmZMziZmxyMzMLGmZAAzYBGYWMaMDgZBsMDAAAAAAAAmxsB",
	...
	[10] = {
		specs = {
			[268] = {
				...
				[7] = {
					label = "Nexus King Salhadaar",
					talentString = "CwQAAAAAAAAAAAAAAAAAAAAAAAAAAgxGmxMmlZsNmZGAAAAAAAWWwoxMDMDjNGsNzMDzyYmx2sYiZb2mxYmNAAYZWmWmtZWGAAAAmhNA",
				},
				[8] = {
					label = "Dimensius",
			...
			[270] = {
				...
				[8] = {
					label = "Dimensius",
					talentString = "C4QAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAmFmB2wMmZWeA2sNLzMb2mlttZmlFmRzMzAzwMYw2MzMMbjxwsYCAAAAAAYxyssMbzMTAAwCA",
				},
			},
		},
	},
	[11] = {
		specs = {
			...
			[105] = {
				...
				[7] = {
					label = "Nexus King Salhadaar",
					talentString = "CkGAAAAAAAAAAAAAAAAAAAAAAYmZmxy2YmZsY2GeAGbbzssYbGAAAAAAAAAAAAbGa2YMNzAMbzsMzMMMDAAAAAYAADAAAAAY2mZrZZmNbMzMDwAjG",
				},
				[8] = {
					label = "Dimensius",
	...
	[12] = {
		specs = {
			...
			[581] = {
				...
				[7] = {
					label = "Nexus King Salhadaar",
					talentString = "CUkAAAAAAAAAAAAAAAAAAAAAAAAGjZmZMmZkZmxYYmZZMMjthZegZMjxMjZmZzMjZGMAAAAALziZMMbMNwMzgN",
				},
				[8] = {
					label = "Dimensius",
