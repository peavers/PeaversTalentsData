	...
	[11] = {
		specs = {
			...
			[103] = {
				...
				[8] = {
					label = "Dimensius",
					talentString = "CcGAAAAAAAAAAAAAAAAAAAAAAAAAAAAgxMbMmFzMmZ2mtHwYbmZGPwMDAAAAAwSwsZgZG1MmlxyMzYMzMAAAAAAgBAAAAoZWmlZmtBAsAmBgFmhB",
				},
			},
			[104] = {
				[0] = {
